...
public class MetsAfrique extends AppCompatActivity {
    RecyclerView list_metaf;
    ArrayList<Modele_Article> arrayList;
    DB_AHITCHE db;
    FloatingActionButton fabmetaf;
    Cursor c;
    int cptpan, pancours;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.mets_afrique);

        db=new DB_AHITCHE(this);
        arrayList=new ArrayList<Modele_Article>();
        list_metaf=findViewById(R.id.list_metaf);
        fabmetaf=findViewById(R.id.Fab_metaf);
        // chargerArt();
        pancours=db.panClientencours(1);
        cptpan=db.cptelmtpanier(pancours);
        RecyclerView.LayoutManager layoutManager=new LinearLayoutManager(MetsAfrique.this);
        list_metaf.setLayoutManager(layoutManager);
        // this.configureOnClickRecyclerView();
        c=db.getAllPatisserie(2);
        final int idmax=db.selmaxpanier(1);
        Toast.makeText(MetsAfrique.this, String.valueOf(idmax), Toast.LENGTH_SHORT).show();
        if (c.getCount()>0){
        ...
        AdaptPatis pa=new AdaptPatis(MetsAfrique.this,arrayList);
        list_metaf.setAdapter(pa);

        fabmetaf.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(MetsAfrique.this,Article_insert.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        tv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(MetsAfrique.this, Panier.class);
                startActivity(intent);
            }
        });
    ...
    private void selectLavelinge() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, DbContract.SERVER_URL_SELECT_PRODUITT+"10",
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            AdaptPatis adapter = new AdaptPatis(MetsAfrique.this, arrayList);
                            // recyclerView.setAdapter(adapter);
                            //  AdaptPatis adaptPatis=new AdaptPatis(Diverselectro.this, arrayList);

                            list_metaf.setAdapter(adapter);
