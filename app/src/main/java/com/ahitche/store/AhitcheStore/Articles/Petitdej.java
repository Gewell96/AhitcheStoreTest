...
public class Petitdej extends AppCompatActivity {

    RecyclerView list_ptitdej;
    ArrayList<Modele_Article> arrayList;
    DB_AHITCHE db;
    FloatingActionButton fabptidej;
    Cursor c;
    int cptpan, pancours;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.petitdej);

        db=new DB_AHITCHE(this);
        arrayList=new ArrayList<Modele_Article>();
        list_ptitdej=findViewById(R.id.list_ptitdej);
        fabptidej=findViewById(R.id.Fab_ptitdej);
        // chargerArt();
        pancours=db.panClientencours(1);
        cptpan=db.cptelmtpanier(pancours);
        RecyclerView.LayoutManager layoutManager=new LinearLayoutManager(Petitdej.this);
        list_ptitdej.setLayoutManager(layoutManager);
        // this.configureOnClickRecyclerView();
        c=db.getAllPatisserie(2);
        final int idmax=db.selmaxpanier(1);
        Toast.makeText(Petitdej.this, String.valueOf(idmax), Toast.LENGTH_SHORT).show();
        if (c.getCount()>0){
        ...
        AdaptPatis pa=new AdaptPatis(Petitdej.this,arrayList);
        list_ptitdej.setAdapter(pa);

        fabptidej.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(Petitdej.this,Article_insert.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        tv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(Petitdej.this, Panier.class);
                startActivity(intent);
            }
        });
    ...
    private void selectLavelinge() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, DbContract.SERVER_URL_SELECT_PRODUITT+"8",
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            AdaptPatis adapter = new AdaptPatis(Petitdej.this, arrayList);
                            // recyclerView.setAdapter(adapter);
                            //  AdaptPatis adaptPatis=new AdaptPatis(Diverselectro.this, arrayList);

                            list_ptitdej.setAdapter(adapter);
