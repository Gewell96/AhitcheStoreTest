...
public class Meteurop extends AppCompatActivity {
    RecyclerView list_meteur;
    ArrayList<Modele_Article> arrayList;
    DB_AHITCHE db;
    FloatingActionButton fabmeteur;
    Cursor c;
    int cptpan, pancours;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.meteurop);

        db=new DB_AHITCHE(this);
        arrayList=new ArrayList<Modele_Article>();
        list_meteur=findViewById(R.id.list_meteurop);
        fabmeteur=findViewById(R.id.Fab_meteurop);
        // chargerArt();
        pancours=db.panClientencours(1);
        cptpan=db.cptelmtpanier(pancours);
        RecyclerView.LayoutManager layoutManager=new LinearLayoutManager(Meteurop.this);
        list_meteur.setLayoutManager(layoutManager);
        // this.configureOnClickRecyclerView();
        c=db.getAllPatisserie(2);
        final int idmax=db.selmaxpanier(1);
        Toast.makeText(Meteurop.this, String.valueOf(idmax), Toast.LENGTH_SHORT).show();
        if (c.getCount()>0){
        ...
        AdaptPatis pa=new AdaptPatis(Meteurop.this,arrayList);
        list_meteur.setAdapter(pa);

        fabmeteur.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(Meteurop.this,Article_insert.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        tv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(Meteurop.this, Panier.class);
                startActivity(intent);
            }
        });
    ...
    private void selectLavelinge() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, DbContract.SERVER_URL_SELECT_PRODUITT+"9",
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            AdaptPatis adapter = new AdaptPatis(Meteurop.this, arrayList);
                            // recyclerView.setAdapter(adapter);
                            //  AdaptPatis adaptPatis=new AdaptPatis(Diverselectro.this, arrayList);

                            list_meteur.setAdapter(adapter);
